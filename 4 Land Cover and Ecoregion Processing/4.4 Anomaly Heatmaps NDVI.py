...
df_main = pd.read_csv("C:/Users/37768378/Documents/Ecology/Graphic Process Detrended Version/NDVI_pentad_5day_with_NDVI_anomaly.csv")
df_geo = pd.read_csv("C:/Users/37768378/Documents/Ecology/EcoRegions/Coord_LCCS_EcoRegions.csv")
...
# Check lccs classes
values_list = df_geo["lccs_class"].unique().tolist()
print(values_list)
...
fig.suptitle(
    "Flash Drought Impact by Phase (NDVI)",
    fontsize=28,
    fontweight="bold"
)
...
with pd.ExcelWriter("Mean_NDVI_Anomaly_By_Phase.xlsx") as writer:
...
print("Saved: Mean_NDVI_Anomaly_By_Phase.xlsx")
...
summary.to_csv(
    "NDVI_Anomaly_Detrended_By_LCCS_Phase.csv",
    index=False
)
